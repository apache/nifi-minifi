...
package org.apache.nifi.minifi.configuration.util;
...
import org.apache.nifi.minifi.configuration.RestChangeNotifier;
...
public abstract class TestRestChangeNotifierCommon {
    ...
    public void testFileUpload() throws Exception {
        ...
        assertEquals("Configuration received, notifying listeners", response.body().string());
